...
export type AssetLinkingCollectionsShopCollectionArgs = {
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
  preview?: Maybe<Scalars['Boolean']>;
  locale?: Maybe<Scalars['String']>;
...
/** Simple web shop [See type definition](https://app.contentful.com/spaces/9mlvny9fa7rl/content_types/shop) */
export type Shop = Entry & {
  __typename?: 'Shop';
  sys: Sys;
  ...
  title?: Maybe<Scalars['String']>;
  description?: Maybe<Scalars['String']>;
  itemImageCollection?: Maybe<AssetCollection>;
};
...
/** Simple web shop [See type definition](https://app.contentful.com/spaces/9mlvny9fa7rl/content_types/shop) */
export type ShopIdArgs = {
  locale?: Maybe<Scalars['String']>;
};


/** Simple web shop [See type definition](https://app.contentful.com/spaces/9mlvny9fa7rl/content_types/shop) */
export type ShopPriceArgs = {
  locale?: Maybe<Scalars['String']>;
};


/** Simple web shop [See type definition](https://app.contentful.com/spaces/9mlvny9fa7rl/content_types/shop) */
export type ShopTitleArgs = {
  locale?: Maybe<Scalars['String']>;
};


/** Simple web shop [See type definition](https://app.contentful.com/spaces/9mlvny9fa7rl/content_types/shop) */
export type ShopDescriptionArgs = {
  locale?: Maybe<Scalars['String']>;
};


/** Simple web shop [See type definition](https://app.contentful.com/spaces/9mlvny9fa7rl/content_types/shop) */
export type ShopItemImageCollectionArgs = {
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
  preview?: Maybe<Scalars['Boolean']>;
  locale?: Maybe<Scalars['String']>;
...
export type ShopFilter = {
  ...
  description_contains?: Maybe<Scalars['String']>;
  description_not_contains?: Maybe<Scalars['String']>;
  itemImageCollection_exists?: Maybe<Scalars['Boolean']>;
